...
/**
 * Jedan dokument u listi: ikona + naziv + meta redak (+ „Arhivirano” badge),
 * te dvije akcije po retku — Preuzmi (native <a download>) i Ispiši (window.print).
 * Akcijski gumbi su ≥44px (touch target) i fokusirajući tipkovnicom.
 */
